/**
 ...
 Conforming types should implement the methods to receive updates about the server and any errors that occur.

 - Note: This protocol inherits from `Sendable` to allow sending messages to the server.
