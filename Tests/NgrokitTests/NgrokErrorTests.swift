...
class NgrokErrorTests: XCTestCase {
  ...
  func testRawValues() {
        ...
        XCTAssertEqual(NgrokError.captchaFailed.rawValue, 1205)
        XCTAssertEqual(NgrokError.accountViolation.rawValue, 1226)
        XCTAssertEqual(NgrokError.gatewayError.rawValue, 3004)
        XCTAssertEqual(NgrokError.tunnelNotFound.rawValue, 3200)
        XCTAssertEqual(NgrokError.accountBanned.rawValue, 3208)
        XCTAssertEqual(NgrokError.passwordTooShort.rawValue, 4011)
        XCTAssertEqual(NgrokError.accountCreationNotAllowed.rawValue, 4013)
        XCTAssertEqual(NgrokError.invalidCredentials.rawValue, 4100)
        XCTAssertEqual(NgrokError.userAlreadyExists.rawValue, 4101)
        XCTAssertEqual(NgrokError.disallowedEmailProvider.rawValue, 4108)
        XCTAssertEqual(NgrokError.htmlContentSignupRequired.rawValue, 6022)
        XCTAssertEqual(NgrokError.websiteVisitWarning.rawValue, 6024)
        XCTAssertEqual(NgrokError.tunnelConnectionFailed.rawValue, 8012)
    }
