...
extension HTTPClient: Session {
  public func data<RequestType>(request: RequestType, withBaseURL baseURLComponents: URLComponents, withHeaders headers: [String: String], authorizationManager _: any AuthorizationManager<AuthorizationType>, usingEncoder encoder: any Encoder<Data>) async throws -> Response where RequestType: PrchModel.ServiceCall {
    ...
    return try await execute(request: request).get()
  }
